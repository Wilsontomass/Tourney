...
The competition will be to write a little python program (only rudimentary python skills necessary) that can play this prisoners dilemma game, and win against everyone elses strategies. Check out this video for context: 
...
You have one month (until 2023/06/28 23:59 Swedish time) to come up with a strategy that can win the tournament! The population in the tournament will
